...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row row-cols-auto">
            <div class="container col-auto col-4">
                        ...
                        <form action="/register" method="POST" class="row g-1">
                            ...
                            <div class="col-">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    name="nama" id="Nama" placeholder="Nama" required value="{{ old('nama') }}">
                                @error('nama')
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div class="col-md-6 mt-2">
                                    <input id="captcha" type="text" class="form-control @error('captcha') is-invalid @enderror" placeholder="Enter Captcha"
