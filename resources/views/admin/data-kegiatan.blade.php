                                                ...
                                                <form action="" method="POST" enctype="multipart/form-data"
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9"><input type="text" id="datepicker"
                                                                name="tanggal" placeholder="Tanggal" class="form-control">
                                                        </div>
                                                    </div>
                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            @foreach ($data as $post)
                                <tr>
                                    <td><a href="/kegiatan/{{ $post['nama_kegiatan'] }}">{{ $post->id_kegiatan }}</a>
                                    </td>
                                    <td><a href="/kegiatan/{{ $post['nama_kegiatan'] }}">{{ $post->nama_kegiatan }}</a>
                                    </td>
                                    <td>
